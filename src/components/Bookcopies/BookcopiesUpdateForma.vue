...
export default {
  ...
  mounted() {
    ...
    this.form.year_published = this.clicked.year_published
    this.form.book_id = this.clicked.book_id
    this.form.publisher_id = this.clicked.publisher_id
  },
  ...
  methods: {
    ...
    onSubmit(event) {
      ...
      let obj = {table: 'bookcopies', id: this.id, year_published: this.form.year_published, book_id: this.form.book_id, publisher_id: this.form.publisher_id, createdAt: this.createdAt, updatedAt: new Date()}
      this.put(obj)
    },
    onReset(event) {
      event.preventDefault()
